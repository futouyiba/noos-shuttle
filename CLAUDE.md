...
Cross-agent workflow norms (review-before-merge, adjudication transport,
orchestrator/integrator roles): see `AGENTS.md` at the repo root, which
links the canonical spec in the docs repo.
...
bash -n scripts/noos-hub-launch.sh
